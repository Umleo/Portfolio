export default function ModalCertificado({
  ...
  return (
    <div className="absolute inset-0 z-50 flex h-screen items-center justify-center bg-black/50 p-3 sm:p-6">
      <div className="relative flex h-[50vh] w-full flex-col rounded-lg bg-gray-800 p-4 text-center lg:max-w-[50vw] lg:p-6 lg:h-[70vh]">
        <button
