...
export default function Bendita() {
        ...
        <div className="minimal-scrollbar flex flex-col items-center overflow-y-auto overflow-x-hidden">
          <div className="rounded-2xl bg-neutral-900 flex flex-col w-full">
            ...
            >
              ...
              do cliente, o sistema irá contar com uma área administrativa onde
              é possível gerenciar os pedidos realizados, incluindo atualização
              de status (como preparo, envio e entrega), controle de
              funcionamento da loja (aberto/fechado) e disponibilidade e
          ...
          <div className="rounded-2xl bg-neutral-900 flex flex-col w-full">
            ...
            >
              ...
              * Registro de endereços <br />O projeto segue em desenvolvimento,
              com foco na evolução do painel administrativo e melhorias na
          ...
          <div className="rounded-2xl bg-neutral-900 flex flex-col w-full">
            ...
            >
              <b>📚 Aprendizados:</b>
              <br />
              Este é meu primeiro projeto fullstack, desenvolvido com o objetivo
              de consolidar e integrar conhecimentos em desenvolvimento web.
              Durante sua construção, venho trabalhando na implementação de boas
              práticas, organização de código e integração entre frontend,
